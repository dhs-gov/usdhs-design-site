...
<p>Although File Inputs are included as part of the Style Guide, their use is strongly discouraged. File Inputs should only be used on systems configured to handle the many security vulnerabilities that they present.</p>
